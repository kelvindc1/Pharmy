...
public class DlgPesquisarCliente extends javax.swing.JDialog {
    ...
    public DlgPesquisarCliente(java.awt.Frame parent, boolean modal, IfrPedido ifrTratamento) {
        super(parent, modal);
        initComponents();
        pedidoView = ifrTratamento;
        new ClienteDAO().popularTabela(tblItem2, "");
    }
    ...
    private void btnSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionarActionPerformed
        ...
        pedidoView.definirValorFuncaoCliente(id, nome);
