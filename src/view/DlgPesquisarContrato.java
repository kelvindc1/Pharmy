 ...
 * @author pretto
 */
public class DlgPesquisarContrato extends javax.swing.JDialog {
     ...
     */
    public DlgPesquisarContrato(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public DlgPesquisarContrato(java.awt.Frame parent, boolean modal, IfrFuncionario ifrTratamento) {
        super(parent, modal);
        initComponents();
        funcionarioView = ifrTratamento;
        new ContratoDAO().popularTabelaFiltro(tblItem2, "");
    }
    ...
    private void btnSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionarActionPerformed
        ...
        funcionarioView.definirValorContrato(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgPesquisarContrato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgPesquisarContrato dialog = new DlgPesquisarContrato(new javax.swing.JFrame(), true);
