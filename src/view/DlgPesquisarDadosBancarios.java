 ...
 * @author pretto
 */
public class DlgPesquisarDadosBancarios extends javax.swing.JDialog {

    IfrFuncionario funcionarioView = null;

    /**
     * Creates new form DlgPesquisarItem
     */
    public DlgPesquisarDadosBancarios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public DlgPesquisarDadosBancarios(java.awt.Frame parent, boolean modal, IfrFuncionario ifrTratamento) {
        super(parent, modal);
        initComponents();
        funcionarioView = ifrTratamento;
        new DadosBancariosDAO().popularTabela(tblItem2, "");
    }
    ...
    private void btnSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionarActionPerformed
        ...
        funcionarioView.definirValorDadosBancarios(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgPesquisarDadosBancarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgPesquisarDadosBancarios dialog = new DlgPesquisarDadosBancarios(new javax.swing.JFrame(), true);
