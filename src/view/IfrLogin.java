...
public class IfrLogin extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnFechar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/system/icons/iconeCancelar.png"))); // NOI18N
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (log.getId_func() != 0 && !log.getEmail().equals("") && !log.getUsuario().equals("") && !log.getUsuario().equals("") && !tffSenha.getText().equals("") && tffSenha.getText().equals(tffRepSenha.getText())) {
