 ...
 * @author pretto
 */
public class DlgPesquisarTipoServicos extends javax.swing.JDialog {

    IfrServicos servicosView = null;

    /**
     * Creates new form DlgPesquisarItem
     */
    public DlgPesquisarTipoServicos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public DlgPesquisarTipoServicos(java.awt.Frame parent, boolean modal, IfrServicos ifrTratamento) {
        super(parent, modal);
        initComponents();
        servicosView = ifrTratamento;
        new Tipo_ServicosDAO().popularTabela(tblItem2, "");
    }
    ...
    private void btnSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionarActionPerformed
        ...
        servicosView.definirValorFuncaoTpServicos(id, nome);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgPesquisarTipoServicos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgPesquisarTipoServicos dialog = new DlgPesquisarTipoServicos(new javax.swing.JFrame(), true);
