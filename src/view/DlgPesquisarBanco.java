 ...
 * @author pretto
 */
public class DlgPesquisarBanco extends javax.swing.JDialog {

    IfrDadosBancarios dadosBancariosView = null;

    /**
     * Creates new form DlgPesquisarItem
     */
    public DlgPesquisarBanco(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public DlgPesquisarBanco(java.awt.Frame parent, boolean modal, IfrDadosBancarios ifrTratamento) {
        super(parent, modal);
        initComponents();
        dadosBancariosView = ifrTratamento;
        new BancoDAO().popularTabela(tblItem2, "");
    }
    ...
    private void btnSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionarActionPerformed
        ...
        dadosBancariosView.definirValorFuncao(id, nome);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgPesquisarBanco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgPesquisarBanco dialog = new DlgPesquisarBanco(new javax.swing.JFrame(), true);
